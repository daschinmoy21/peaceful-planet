...
const experiences = [
    {
        ...
        period: '2023 - Present',
        description: 'Leading the development of core infrastructure and mentoring junior engineers.',
    },
    {
        company: 'Startup Inc',
        role: 'Full Stack Developer',
        period: '2021 - 2023',
        description: 'Built and shipped multiple features for the flagship product using React and Node.js.',
    },
    {
...
export default function Experience() {
    return (
        ...
        >
            <h1 className="text-3xl font-bold mb-8 ml-5 text-white w-fit">Experience</h1>

            <div className="space-y-6 ml-5">
                {experiences.map((exp, index) => (
                    <div key={index} className="relative pl-8 border-l border-zinc-700/50 hover:border-zinc-500 transition-colors">
