...
export default function Contact() {
    const socials = [
        { name: 'GitHub', icon: faGithub, link: 'https://github.com/daschinmoy21', color: 'hover:text-white' },
        { name: 'LinkedIn', icon: faLinkedin, link: '#', color: 'hover:text-[#0077b5]' },
        { name: 'Twitter', icon: faTwitter, link: '#', color: 'hover:text-[#1DA1F2]' },
        { name: 'Email', icon: faEnvelope, link: 'mailto:contact@example.com', color: 'hover:text-emerald-400' },
    ];
